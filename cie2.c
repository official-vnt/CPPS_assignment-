...
//PROBLEM STATEMENT: To develop a Parking Slot Management System using C language that allocates parking slots to vehicles, tracks occupied and vacant slots, manages vehicle entry and exit, and calculates parking charges efficiently through a menu-driven program.
...
#define MAX 10
#define RATE 20 
// RATE is the parking charge per hour
...
//in this Program i have use seprate functions for being cleared about every one of it
...
int main() {
    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 4:
                printf("Thank you!\n");
                return 0;   // Clean exit without stdlib.h
            default:
